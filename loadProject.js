...
const titles = ["Streak Tracker", "EcoMaps", "Digit Recognition", "Sorting Visualizer", "MakeMeLaugh", "A* Pathfinding", "Wordle Clone", "Geography Quiz", "Live Filter", "Pokemon", "Javascript Pokemon", "Blackjack"];
...
const videos = [
    "videos/tracker.mp4", "videos/eco.mp4", "videos/ml.mp4", "videos/sort.mp4", "videos/laugh.mp4", "videos/path.mp4", "videos/wordle.mp4", "videos/map.mp4", "videos/filter.mp4", "videos/pokemon.mp4", "videos/javascriptPokemon.mp4", "videos/blackjack.mov"
];
...
const brs = [2, 2, 2, 3, 2, 3, 3, 3, 3, 1, 2, 2];
